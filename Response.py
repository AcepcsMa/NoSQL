...
class responseCode:
    ...
    detail = {
        ...
        HASH_GET_SUCCESS:"Hash Get Success",
        HASH_EXPIRED:"Hash Is Expired",
        ...
        LIST_ALREADY_EXIST:"List Already Exists",
        ...
        SET_ALREADY_EXIST:"Set Already Exists",
        SET_LENGTH_TOO_SHORT: "Set Length Is Too Short",
        SET_GET_SUCCESS: "Set Value Get Success",
        SET_EXPIRED:"Set Is Expired",
        SET_NOT_EXIST:"Set Does Not Exist",
        SET_SEARCH_SUCCESS:"Search Set Success",
